...
import { VOOR_WIE_MEGA_MENU, VOOR_WIE_SEGMENTS } from "@/lib/voor-wie-content";

export function VoorWieMobileLinks({ onNavigate }: { onNavigate: () => void }) {
  return (
    <div className="flex flex-col gap-3 pb-2">
      ...
      <Link
        to={VOOR_WIE_MEGA_MENU.overviewHref}
        onClick={onNavigate}
